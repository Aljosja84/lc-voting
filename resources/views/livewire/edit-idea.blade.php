<div x-cloak x-data="{ isOpen: false }" x-show="isOpen" @custom-show-edit-modal.window ="isOpen = true"
    class="modal fixed z-10 inset-0 overflow-y-auto" @click.away="isOpen = false"
     x-transition.origin.bottom.duration.300ms.ease-in-out>

    <div class="flex items-end justify-center">
        <div class="modal-backdrop fixed bg-gray-500 bg-opacity-50" aria-hidden="false"></div>

        <div class="bg-white shadow-lg rounded-lg rounded-tr overflow-hidden transform transition-all py-4 sm:max-w-lg sm:w-full">
