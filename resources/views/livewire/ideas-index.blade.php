<div>
    <div class="filters flex space-x-6">
        ...
        <div class="w-1/3">
            <select wire:model="filter" name=other_filters" id="other_filters" class="w-full rounded-xl border-none px-4 py-2">
                ...
                @admin
                    <option value="Spam">Spam Ideas</option>
                @endadmin
            </select>
        </div>
        <div class="w-2/3 relative">
            <input wire:model="search" type="search" placeholder="Find an idea" class="w-full rounded-xl placeholder-gray-900 border-none px-4 py-2 pl-8">
    ...
    <div class="ideas-container space-y-6 my-6">
        ...
        @empty
            <div class="mx-auto w-70 h-16 bg-white text-center pt-6">No ideas found :(</div>
            <!-- end idea container -->
        @endforelse
